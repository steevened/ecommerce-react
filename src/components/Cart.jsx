...
const Cart = ({ cart }) => {
  ...
  return (
    <div
      ...
      } bottom-0  max-w-[320px] bg-base-200 shadow-2xl w-3/4  z-10 flex flex-col  gap-3 transition-all ease-in-out duration-500 px-4`}
    >
      <h1 className='text-xl'>Your Cart</h1>
      <div className='relative  w-full h-full'>
        <div className='text-left  mt-3 flex flex-col gap-10 overflow-auto h-full'>
          ...
          <div className='flex justify-between absolute border-t-2 pt-1  w-full right-0 bottom-5'>
